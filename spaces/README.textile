...
* M-x sp-switch-space
* Type "default" and press enter. This creates a new space.
* M-x sp-switch-space
* Type "gdb" and press enter. Now you have two spaces, one named "default" and one named "gdb".
...
* M-x sp-switch-space
* Select the "default" space to reload your previous window config. Use sp-switch-space to switch back and forth between the spaces.
